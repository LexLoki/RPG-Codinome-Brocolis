...
function audioManager.load()
  ...
  audioManager.robotMusic = love.audio.newSource("/Assets/Music/Fase Robo.mp3")
  audioManager.pirateMusic = love.audio.newSource("/Assets/Music/Fase Pirata.mp3")
  audioManager.brocolisMusic = love.audio.newSource("/Assets/Music/Fase Brocolis.mp3")
  audioManager.alienMusic = love.audio.newSource("/Assets/Music/Fase Alienigena.mp3")
  audioManager.endMatchMusic = love.audio.newSource("/Assets/Music/Partida Terminada.mp3")
